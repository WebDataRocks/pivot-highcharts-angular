...
export class WebDataRocksPivot {
  ...
  @Output()
  celldoubleclick: EventEmitter<WebDataRocks.Cell> = new EventEmitter();
  ...
  ngOnInit() {
    this.webDataRocks = window["WebDataRocks"]({
      ...
      celldoubleclick: (cell: WebDataRocks.Cell) =>
      ...
      loadinglocalization: (event: Object) =>
        this.loadinglocalization.next(event),
      ...
      localizationloaded: (event: Object) =>
        this.localizationloaded.next(event),
      ...
      reportfilecancelled: (event: Object) =>
        this.reportfilecancelled.next(event),
